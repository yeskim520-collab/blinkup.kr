  ...
  return (
    <div className="w-full bg-white px-6 md:px-12 lg:px-16 xl:px-20 pt-9 pb-16 lg:py-20 animate-fade-in">
      <div className="max-w-[920px] mx-auto w-full">
        ...
        <h1 className="mt-3 text-[36px] sm:text-[44px] md:text-[48px] lg:text-[54px] font-normal leading-[1.2] lg:leading-[1.16] tracking-[-0.02em] text-black font-serif-display break-keep">
          {article.title}
        </h1>
        ...
        <div className="mt-7 p-5 sm:p-6 lg:p-8 border-l-[3px] border-black bg-neutral-50 text-black text-[17px] sm:text-[18px] lg:text-[19px] leading-[1.65] font-normal tracking-[-0.015em] break-keep">
          {article.summary}
        </div>

        {/* 6. 본문 (긴 글을 읽기 편한 editorial article 형식) */}
        <div className="mt-8 lg:mt-10 space-y-6 text-[16px] sm:text-[17px] lg:text-[18px] leading-[1.78] lg:leading-[1.85] text-black/90 font-normal tracking-[-0.015em] break-keep font-sans">
        ...
        {article.keyTakeaways && article.keyTakeaways.length > 0 && (
          <div className="mt-10 lg:mt-12 p-6 lg:p-8 border-[1.5px] border-black bg-white space-y-3.5">
