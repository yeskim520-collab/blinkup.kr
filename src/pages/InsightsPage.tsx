...
export const InsightsPage: React.FC<InsightsPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="px-6 pt-9 pb-16 bg-white animate-fade-in">
      {/* 1. 작은 라벨: Insights */}
      ...
      <h1 className="mt-2.5 sm:mt-3 text-[42px] sm:text-[50px] md:text-[56px] font-normal leading-[1.18] tracking-[-0.02em] text-black font-serif-display break-keep">
        생각을 나누고,<br />
        가능성을 발견합니다
      </h1>

      {/* 3. 설명: 사람과 사업, 브랜드와 AI, 새로운 일하는 방식에 대한 BlinkUp의 생각과 경험을 기록합니다. */}
      <p className="mt-3.5 sm:mt-4 text-[16px] sm:text-[17px] leading-[1.6] text-black/85 font-normal tracking-[-0.015em] break-keep">
      ...
      {/* 5. 칼럼 목록: 선, 여백, 큰 제목 중심의 단정한 에디토리얼 리스트 */}
